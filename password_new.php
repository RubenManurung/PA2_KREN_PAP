<?php
	...
	if(isset($_POST['reset'])){
		...
		if($password != $repassword){
			...
			if($row['numrows'] > 0){
				...
				try{
					...
					$_SESSION['success'] = 'Kata sandi berhasil diatur ulang.';
				...
				$_SESSION['error'] = 'Kode tidak cocok dengan pengguna.';
				header('location: '.$path);
			}
		...
		$_SESSION['error'] = 'Masukkan kata sandi baru terlebih dahulu.';
		header('location: '.$path);
	}
