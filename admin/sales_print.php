<?php
	...
	if(isset($_POST['print'])){
	    ...
	    $content = '';  
	    $content .= '
	      	<h2 align="center">Usaha Bubuk Kopi "IDA" Sidikalang</h2>
			
			  <h5 align="center">Jln.Sudirman NO.20 , Sidikalang</h5>
			  <h4 align="center">REPORT PENJUALAN</h4>
	      	<h4 align="center">'.$from_title." - ".$to_title.'</h4>
	      	<table border="1" cellspacing="0" cellpadding="3">  
	           <tr>  
	           		<th width="15%" align="center"><b>Tanggal</b></th>
	                <th width="30%" align="center"><b>Nama Pembeli</b></th>
					<th width="40%" align="center"><b>Kode Transaksi</b></th>
					<th width="15%" align="center"><b>Biaya</b></th>  
	           </tr>  
	      ';  
		...
		$_SESSION['error'] = 'Perlu rentang tanggal untuk menyediakan cetakan penjualan';
